...
def make_blank_object():
    ...
    obj = {"XYs": [], "Matrix seq": [], "Matrix": None,
           "Color": "black", "Name": "name", "Pts": None}
    return obj
...
def plot_object_in_own_coord_system(axs, obj):
    ...
    axs.plot(xs, ys, color=col, linestyle='dashed',
             marker='x', label=obj["Name"])
...
def plot_object_in_world_coord_system(axs, obj, in_matrix=None):
    ...
    axs.plot(pts_in_world[0, :], pts_in_world[1, :],
             color=col, linestyle='solid', label=obj["Name"])
...
def plot_world(axs, world, objs, camera):
    ...
    axs.plot(xs, ys, color="blue", linestyle='solid',
             marker='o', label=world["Name"])
